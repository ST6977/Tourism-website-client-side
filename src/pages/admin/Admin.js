...
const Admin = () => {
  ...
  useEffect(() => {
    axios
      .get("https://creepy-cat-14143.herokuapp.com/register")
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://creepy-cat-14143.herokuapp.com/register/${id}`)
      .then((res) => {
        ...
        <table class="min-w-full border-collapse block md:table">
          <thead class="block md:table-header-group">
            <tr class="border border-grey-500 md:border-none block md:table-row absolute -top-full md:top-auto -left-full md:left-auto  md:relative ">
              <th class="bg-green-800 p-2 text-white font-bold md:border md:border-grey-500 text-left block md:table-cell">
                Name
              </th>
              <th class="bg-green-800 p-2 text-white font-bold md:border md:border-grey-500 text-left block md:table-cell">
                Email Address
