        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="flex-1 flex items-center justify-center lg:items-stretch lg:justify-start">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/">
                <h1 className="text-2xl   text-white">ShareTrip</h1>
              </Link>
            </div>
              ...
              <div>
                {user ? (
                  ...
                  <button
                    ...
                    type="button"
                    className="bg-gray-400 flex justify-center items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                    id="user-menu-button"
                    aria-expanded="false"
                    aria-haspopup="true"
                  >
                  ...
                  <button
                    onClick={handleLogin}
                    className="px-5 rounded text-white font-bold py-2 bg-indigo-700"
                  >
                    Login
                  </button>
                )}
